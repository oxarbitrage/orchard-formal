...
See §4.16 and §5.4.8.3 of the [Zcash protocol specification](https://zips.z.cash/protocol/protocol.pdf).
...
No mathematical claims are axiomatized — all security properties are proven from the algebraic structure.
